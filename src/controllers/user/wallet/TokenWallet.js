...
const tokenAddress = '0xa621777874B06eb17254cDc7D68F004069F27755'; 
const tokenABI = [
	{
		"inputs": [
			{
...
export const getTokenBalance = async (req, res) => {
    ...
    try {
        ...
        console.error('Error when retrieving token balance:', error);
        res.status(500).json({ error: 'Error when retrieving token balance' });
    }
};
