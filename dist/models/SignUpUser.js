...
var SignUpUser = /*#__PURE__*/function (_Model) {
  function SignUpUser() {
    _classCallCheck(this, SignUpUser);
    return _callSuper(this, SignUpUser, arguments);
  }
  _inherits(SignUpUser, _Model);
  return _createClass(SignUpUser, null, [{
    key: "associate",
...
SignUpUser.init({
  nickname: _sequelize.DataTypes.STRING,
  email: {
